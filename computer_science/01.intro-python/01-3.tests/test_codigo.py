...
# get_most_ordered_dish_per_costumer é uma função que retorna
# o prato mais pedido por uma
...
def test_order_frequency_per_costumer_when_customer_is_joao_and_order_is_pizza(
    orders,
):
    assert get_order_frequency_per_costumer(orders, "joao", "pizza") == 0


def test_order_frequency_when_customer_is_maria_order_is_hamburger(
    orders,
):
